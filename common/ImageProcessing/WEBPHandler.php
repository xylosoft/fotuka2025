...
class WEBPHandler extends BaseImageHandler {

    public function __construct($filename, $assetId){
        $this->attributes[self::FILE_FORMAT] = self::FORMAT_WEBP;
        $this->attributes[self::VALID_FORMATS] = array(self::FORMAT_WEBP, self::FORMAT_PNG, self::FORMAT_JPEG, self::FORMAT_JPG, self::FORMAT_GIF,
